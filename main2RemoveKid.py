		...
		if len(bullet) >= 47 and len(bullet)!=50:
			...
			if highScore > highestScore:
				...
				if highestScore > len(goodChild)*100:
					print highestScorePattern
					goodChild[highestScorePattern]=highScore
			...
			if len(goodChild) >=2:
				...
				tail=random.randint(0,len(goodChild)-1)
				head=random.randint(0,len(goodChild)-1)
				...
				bullet = goodChild.keys()[random.randint(0,len(goodChild)-1)][head:tail]
				bullet += goodChild.keys()[random.randint(0,len(goodChild)-1)][head:tail]
